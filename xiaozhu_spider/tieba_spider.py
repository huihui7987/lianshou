...
class spider(object):
    ...
    def pagechange(self, url, total_page):
    ...
    def getinfo(self, eachclass):
        ...
        time_lever = re.findall('<em>(.*?)</em>', eachclass, re.S)
        info['classtime'] = (time_lever[0]).replace('\t', '').replace('\n', '')
        info['classlever'] = time_lever[1]
...
if __name__ == '__main__':
    ...
    all_links = jikespider.pagechange(url, 6)
